...
public class FaceScanActivity extends AppCompatActivity {
    private static final String TAG = FaceScanActivity.class.getSimpleName();
    ...
    private void saveImage(Bitmap picture) {
        stopCameraSource();
        Intent intent = new Intent(FaceScanActivity.this, ImagePreviewActivity.class);
...
//        }
    ...
    private boolean checkGooglePlayAvailability() {
        ...
        if (resultCode == ConnectionResult.SUCCESS) {
            ...
            googleApiAvailability.getErrorDialog(FaceScanActivity.this, resultCode, 2404).show();
        }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(FaceScanActivity.this, "Camera Permission Required", Toast.LENGTH_LONG).show();
                finish();
            }
        }
        ...
        if (requestCode == REQUEST_STORAGE_PERMISSION) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(FaceScanActivity.this, "Storage Permission Required", Toast.LENGTH_LONG).show();
            }
        }
    }
